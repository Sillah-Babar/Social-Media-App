...
public class ProfileStatusController implements Initializable {
    ...
    void actionHandled(ActionEvent event) throws IOException {
        ...
        else if(event.getSource()==checkbox)
        {
            ...
            pf.setPublic_profile(value);
            if(value==true)
            {
                showmessage.setText("Your profile has been made public");
            }
            else
            {
                showmessage.setText("Your profile has been made private");
            }
        }
